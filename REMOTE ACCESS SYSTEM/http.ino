...
void SubmitHttpRequest()
{
  ...
  mySerial.println("AT+SAPBR=3,1,\"internet\",\"CMNET\"");//setting the APN, the second need you fill in your local apn server
  delay(4000);
  ...
  mySerial.println("AT+HTTPPARA=\"URL\",\"robi-pilot.herokuapp.com/getCommand/1\"");// setting the httppara, the second parameter is the website you want to access
  delay(1000);
