...
void setup()
{
  ...
  mySerial.println("AT+SAPBR=3,1,\"APN\",\"gpinternet\"");//setting the APN, the second need you fill in your local apn server
  delay(4000);
...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println("AT + CMGS = \"+8801534831804\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
...
void DialVoiceCall()
{
  mySerial.println("ATD + +8801534831804;");//dial the number
  delay(100);
  mySerial.println();
}
...
{   
  mySerial.println("AT+HTTPPARA=\"URL\",\"robi-pilot.herokuapp.com/getAllCommands/\"");// setting the httppara, the second parameter is the website you want to access
  delay(1000);
